...
const Navbar = ({ handleLogout }: { handleLogout: () => void }) => {
  ...
  return (
    <div className='fixed top-0 w-full h-20 bg-gray-800 bg-opacity-50 flex items-center justify-around shadow-md text-white z-20'>
  ...
  <div className="w-3/12 flex justify-center z-20">
    <Link href="#" className="nav-item font-mono text-lg hover:text-blue-500 transition duration-300">Contact</Link>
  </div>
